...
const sponsors = [
  ...
  // { id: 's2', name: 'SRI BALAJI NAGAR', image: require('../images/event_posters/default.jpg'), website: '#', category: 'Platinum', description: 'Comprehensive services with quality offerings for community needs.' },
...
const coSponsors = [
  ...
  // { id: 'c5', name: 'JAYAN FITNESS SCHOOL', image: require('../images/event_posters/default.jpg'), website: '#', category: 'Co-Sponsor', description: 'Professional fitness training and wellness programs for all ages.' },
  // { id: 'c6', name: 'KSM KARTHIK MC', image: require('../images/event_posters/default.jpg'), website: '#', category: 'Co-Sponsor', description: 'Quality services for all your entertainment needs.' },
  ...
  // { id: 'c11', name: 'KAMALAM AGORA AGENCIES TINDIVANAM', image: require('../images/event_posters/default.jpg'), website: '#', category: 'Co-Sponsor', description: 'Quality products and services for your daily needs.' },
 ...
 // { id: 'c14', name: 'KASIM PAINT & CO', image: require('../images/event_posters/default.jpg'), website: '#', category: 'Co-Sponsor', description: 'Premium paint solutions and home improvement products.' },
